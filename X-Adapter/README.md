...
Set `--controlnet_canny_path` or `--controlnet_depth_path` to ControlNet's path in the bash script. The default value is its Hugging Face model card. 
    ...
    /mnt/workspace/workgroup/xdj/models/AIGC/sd_model/model_path/models/control_v11p_sd15_canny
    /mnt/workspace/workgroup/xdj/models/AIGC/sd_model/model_path/models/control_v11p_sd15_depth
