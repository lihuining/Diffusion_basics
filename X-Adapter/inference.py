...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        nargs='+', help='start of 2nd stage', default=[0,0.5,1.0]#[0.6, 0.65, 0.7, 0.75, 0.8]
    )
    parser.add_argument(
        "--adapter_condition_scale_list",
        nargs='+', help='X-Adapter scale', default=[0,0.5,1.0]#[0.8, 1.0, 1.2]
    )
    parser.add_argument(
        "--base_path",
        type=str, help='path to base model', default="/mnt/workspace/workgroup_share/lhn/utils/runwayml/stable-diffusion-v1-5" #runwayml/stable-diffusion-v1-5"
    )
    parser.add_argument(
        "--sdxl_path",
        type=str, help='path to SDXL', default="/mnt/workspace/workgroup_share/lhn/utils/stabilityai/stable-diffusion-xl-base-1.0" #"stabilityai/stable-diffusion-xl-base-1.0"
    )
    parser.add_argument(
        "--path_vae_sdxl",
        type=str, help='path to SDXL vae', default="/mnt/workspace/workgroup_share/lhn/utils/madebyollin/sdxl-vae-fp16-fix" #"madebyollin/sdxl-vae-fp16-fix"
    )
    parser.add_argument(
        "--adapter_checkpoint",
    ...
    parser.add_argument(
        ...
        type=str, help='path to canny controlnet', default="/mnt/workspace/workgroup/xdj/models/AIGC/sd_model/model_path/models/control_v11p_sd15_canny" # lllyasviel/sd-controlnet-canny
    )
    parser.add_argument(
