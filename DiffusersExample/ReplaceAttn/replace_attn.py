...
controlnet = ControlNetModel.from_pretrained(
    "/mnt/workspace/workgroup_share/lhn/models/lllyasviel/sd-controlnet-canny").to('cuda')

pipeline = VideoEditingPipeline.from_pretrained(
    '/mnt/workspace/workgroup_share/lhn/models/runwayml/stable-diffusion-v1-5', controlnet=controlnet).to('cuda')
